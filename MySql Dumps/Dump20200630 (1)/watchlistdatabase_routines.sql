...
BEGIN
   ...
   DECLARE cursor_List CURSOR FOR 
      select e1.airDate, e1.episodeCode from watchlistdatabase.episodes e1 where e1.showName = showName and e1.wasIncremented = 0
    ;
...
-- Dump completed on 2020-07-01 22:51:21
