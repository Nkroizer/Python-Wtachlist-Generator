...
WtachlistGeneratorBtn = Button(frame, text="Watchlist Generator", command=openWtachlistGenerator, width=15)

DataAnalysisBtn = Button(frame, text="Data Analysis", command=openDataAnalysis, width=15)
